...
| --- | --- | --- | --- | --- |
| 0.9 | [![Build Status](https://travis-ci.com/rapydo/do.svg?branch=0.9)](https://travis-ci.com/rapydo/do/branches) | [![Build Status](https://travis-ci.com/rapydo/http-api.svg?branch=0.9)](https://travis-ci.com/rapydo/http-api/branches) | [![Build](https://github.com/rapydo/build-templates/workflows/Docker%20Build/badge.svg?branch=0.9+workflow%3A%22Docker+Build%22)](https://github.com/rapydo/build-templates/actions?query=branch%3A0.9) | [![Build Status](https://travis-ci.com/rapydo/rapydo-angular.svg?branch=0.9)](https://travis-ci.com/rapydo/rapydo-angular/branches) |
