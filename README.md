...
| --- | --- | --- |
| **0.7.0** | --- | Under development (stable) |
...
| 0.6.8 | [![Build Status](https://travis-ci.org/rapydo/do.svg?branch=0.6.8)](https://travis-ci.org/rapydo/do?branch=0.6.8) | [![Build Status](https://travis-ci.org/rapydo/utils.svg?branch=0.6.8)](https://travis-ci.org/rapydo/utils?branch=0.6.8) | [![Build Status](https://travis-ci.org/rapydo/http-api.svg?branch=0.6.8)](https://travis-ci.org/rapydo/http-api?branch=0.6.8) | [![Build Status](https://travis-ci.org/rapydo/build-templates.svg?branch=0.6.8)](https://travis-ci.org/rapydo/build-templates?branch=0.6.8) | [![Build Status](https://travis-ci.org/rapydo/rapydo-angular.svg?branch=0.6.8)](https://travis-ci.org/rapydo/rapydo-angular?branch=0.6.8) |
